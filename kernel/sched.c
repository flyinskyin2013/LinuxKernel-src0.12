...
void sched_init(void)
{
	...
	set_tss_desc(gdt+FIRST_TSS_ENTRY,&(init_task.task.tss));//gdt[4]=gdt[FIRST_TSS_ENTRY]
	set_ldt_desc(gdt+FIRST_LDT_ENTRY,&(init_task.task.ldt));//gdt[5]=gdt[FIRST_LDT_ENTRY]
