...
/*
 * Limited emulation 27.12.91 - mostly loads/stores, which gcc -march=i386 -m32  wants
...
/*
 * This file is full of ugly macros etc: one problem was that gcc -march=i386 -m32  simply
