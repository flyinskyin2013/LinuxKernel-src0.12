...
#ifndef __GNUC__
#error I want gcc -march=i386 -m32 !
#endif
 ...
 * functions. Use gcc -march=i386 -m32 . It also assumes ds=es=data space, this should be
...
{
char * _tmp_src = (char*)src+n-1;
char * _tmp_dst = (char*)dest+n-1;
if (dest<src)
__asm__("cld\n\t"
	"rep\n\t"
	"movsb"
