...
/* filp */	{NULL,}, \
	{ \
		{0,0}, \
/* ldt 代码长640K，基址0x0，G=1，D=1，DPL=3，P=1 TYPE=0xa*/	{0x9f,0xc0fa00}, \
		{0x9f,0xc0f200}, \
	}, \
...
//modify by sky on 20210307  set the %2 to ebx to fix the inst error
//$1, $2, $3 has some problems
...
#define get_base(ldt) _get_base_sky( ((char *)&(ldt)) )
